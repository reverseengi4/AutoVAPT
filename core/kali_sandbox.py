...
class KaliSandbox(BaseSandbox):
    ...
    Each instance owns exactly one container named 'autovapt-{scan_id}'.
    """
    ...
    def __init__(
        self,
        scan_id: str,
        image: str = "autovapt-kali:latest",
        memory_limit: str = "2g",
        cpu_limit: float = 2.0,
        network_mode: str = "bridge",
    ):
        self.scan_id = scan_id
        self.container_name = f"autovapt-{scan_id}"
        self.image = image
    ...
    async def initialize(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            return False, (
                ...
                "Build with: docker build -f docker/Dockerfile.kali -t autovapt-kali:latest docker/"
            )
        ...
        try:
            ...
            self._container = self._client.containers.run(
                ...
                labels={
                    "autovapt.scan_id": self.scan_id,
                    "autovapt.type": "kali-sandbox",
                },
            )
            self._available = True
            self._created_at = datetime.utcnow()
