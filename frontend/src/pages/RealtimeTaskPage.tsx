...
export default function RealtimeTaskPage() {
  ...
  const renderMessage = (msg: RealtimeMessage, index: number) => {
    ...
    return (
      ...
      >
        <div
          className={`max-w-[85%] rounded-xl px-4 py-3 shadow-lg overflow-hidden ${isUser
        ...
        >
          {!isUser && (
            <div className="flex items-center gap-2 mb-2 text-xs text-dark-400">
              ...
              <span>{isToolExecution ? 'Tool Execution' : 'AutoVAPT AI'}</span>
              {isApiError && (
    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          {llmStatus && (
            <div
              className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs cursor-help ${llmStatus.available
          ...
          {toolsStatus && (
            <div
              className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs cursor-help ${toolsStatus.available
            ...
            <div className="space-y-2 max-h-[400px] overflow-y-auto">
              {sessions.length === 0 ? (
                ...
                sessions.map((s) => (
                  <div
                    key={s.session_id}
                    className={`p-3 rounded-xl cursor-pointer transition-all ${activeSession?.session_id === s.session_id
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {['critical', 'high', 'medium', 'low', 'info'].map(sev => {
                  ...
                  return (
                    <div
                      key={sev}
                      className={`px-2 py-1 rounded-lg text-xs font-medium flex items-center gap-1 ${sev === 'critical' ? 'bg-red-500/20 text-red-400' :
                        ...
                        <div className="flex items-start gap-2 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-0.5">
                              ...
                              {finding.cvss_score && (
                                <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded ${finding.cvss_score >= 9.0 ? 'bg-red-500/20 text-red-400' :
                          ...
                          <div className="mt-3 flex flex-wrap gap-2">
                            {finding.cvss_score && (
                              <div className="bg-dark-800 px-2 py-1 rounded text-xs">
                                ...
                                <span className={`font-bold ${finding.cvss_score >= 9.0 ? 'text-red-400' :
