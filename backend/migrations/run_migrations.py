#!/usr/bin/env python3
"""
Run database migrations for AutoVAPT v1
...
def get_db_path():
    ...
    possible_paths = [
        Path("./data/autovapt.db"),
        Path("../data/autovapt.db"),
        Path("/opt/AutoVAPTv1/data/autovapt.db"),
        Path("/opt/AutoVAPTv1/backend/data/autovapt.db"),
    ]
