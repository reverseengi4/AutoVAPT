    ...
    async def generate(
        ...
        if format == "html":
            ...
            try:
                ...
                print("xhtml2pdf not installed, falling back to HTML")
                content = html_content
                filename = f"report_{timestamp}.html"
                is_binary = False
        else:
...
<body>
    <div class="container">
        <div class="header">
            <h1>AutoVAPT Security Report</h1>
        ...
        <div class="footer">
            <p>Generated by AutoVAPT v1 - AI-Powered Penetration Testing Platform</p>
        </div>
    </div>
</body>
</html>"""
