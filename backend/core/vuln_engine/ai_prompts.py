"""
AutoVAPT v1 - Per-Vulnerability AI Decision Prompts
...
VULN_AI_PROMPTS: Dict[str, dict] = {
    ...
    "xss_reflected": {
        ...
        "payload_selection": "Start with probe: AutoVAPT{{RANDOM_ID}} then context-specific: HTML body: <script>alert(document.domain)</script> Attribute: \" onmouseover=alert(1) x=\" JS string: ';alert(1)// Event handler: <img src=x onerror=alert(1)> SVG: <svg onload=alert(1)>",
