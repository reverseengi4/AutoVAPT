#!/usr/bin/env bash
# ============================================================================
# AutoVAPT v1 - Rebuild & Launch Script
# ============================================================================
...
PROJECT_DIR="/opt/AutoVAPT"
VENV_DIR="$PROJECT_DIR/venv"
FRONTEND_DIR="$PROJECT_DIR/frontend"
DATA_DIR="$PROJECT_DIR/data"
LOGS_DIR="$PROJECT_DIR/logs"
PID_DIR="$PROJECT_DIR/.pids"
DB_PATH="$DATA_DIR/autovapt.db"
...
echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}  AutoVAPT v1 - Autonomous Security Agent${NC}"
echo -e ""
