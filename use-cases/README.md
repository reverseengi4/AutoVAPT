# AutoVAPT v1 Use Cases

This directory contains practical use cases and guides for leveraging AutoVAPT v1 in various security testing scenarios.
...
**Description**: Comprehensive guide on performing authenticated web application vulnerability testing using AutoVAPT v1 and OWASP ZAP with session cookies.

**Key Topics Covered**:
- Overview of AutoVAPT v1 framework
...
**Prerequisites**:
- AutoVAPT v1 installed and configured
- OWASP ZAP installed
...
- [Main AutoVAPT v1 README](../README.md)
