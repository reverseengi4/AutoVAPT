# AutoVAPT v1 - Quick Start Guide

Get AutoVAPT running in under 5 minutes.
...
```bash
git clone https://github.com/your-org/AutoVAPT.git
cd AutoVAPT
...
> **No Docker?** AutoVAPT works without it -- the agent uses HTTP-only testing. Docker adds tool-based scanning (Nuclei, Nmap, etc.).

---

## Step 4: Start AutoVAPT
