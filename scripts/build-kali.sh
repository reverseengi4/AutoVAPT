#!/bin/bash
# AutoVAPT v1 - Build Kali Linux Sandbox Image
#
# Usage:
...
IMAGE_NAME="autovapt-kali:latest"

cd "$PROJECT_DIR"

echo "================================================"
echo " AutoVAPT Kali Sandbox Builder"
echo "================================================"
echo ""
...
echo "   - Start AutoVAPT backend (it auto-creates containers per scan)"
